...
`               <h4>5 Steps For Giving De-Wormer To Horses</h4>
                ...
                <p>1. Approach and retreat placing your finger on the lips of your horse's mouth near their interdential gap.</p>
                <p>2. Approach and retreat placing your finger inside your horse's mouth at the interdential gap, touching the tounge.</p>
                <p>Now we're repeating the steps above, but with the syringe instead of your finger.</p>
                <p>3. With de-wormer in hand (keep cap on the syringe), approach and retreat placing the syringe on the lips of your horse's mouth near their interdential gap.</p>
                <p>4. With de-wormer in hand (keep cap on the syringe), approach and retreat placing the syringe inside your horse's mouth at the interdential gap, touching the tounge.</p>
                <p>5. Remove cap from de-wormer syringe and slide it into the horse's interdential gap. Quickly squeeze desired de-wormer paste into the horse's mouth.</p>
            </div>
            <div id="abusedDiv">
