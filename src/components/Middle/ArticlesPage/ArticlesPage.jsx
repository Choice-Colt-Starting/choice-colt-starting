                ...
                <div className="textContentDivs">
                    ...
                    <div className="sectionInfoDivParent">
                        <div className="sectionInfoDiv">
                            ...
                            <p><b>1.</b> Approach and retreat placing your finger on the lips of your horse's mouth near their interdential gap.</p>
                            <p><b>2.</b> Approach and retreat placing your finger inside your horse's mouth at the interdential gap, touching the tounge.</p>
                            <p>Now we're repeating the steps above, but with the syringe instead of your finger.</p>
                            <p><b>3.</b> With de-wormer in hand (keep cap on the syringe), approach and retreat placing the syringe on the lips of your horse's mouth near their interdential gap.</p>
                            <p><b>4.</b> With de-wormer in hand (keep cap on the syringe), approach and retreat placing the syringe inside your horse's mouth at the interdential gap, touching the tounge.</p>
                            <p><b>5.</b> Remove cap from de-wormer syringe and slide it into the horse's interdential gap. Quickly squeeze desired de-wormer paste into the horse's mouth.</p>
                        </div>
                    </div>
                </div>
            </div>
